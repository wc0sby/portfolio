const infoObj = {
  ...
  projects: {
    title: 'Projects',
    subtitle: '',
    text: `Below are a few of my projects that I've completed as a student of ACA.  You may also navigate to other works using the hamburger icon on the top left of this page.`
  },
  contact: {
    title: 'Contact',
    subtitle: '',
